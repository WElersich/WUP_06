...
```
Because the p-values are very low, we can reject the null hypothesis. Furthermore, the odds ratio given by this test states that white people people are 2.343236 times more likely than black people to support capital punishment.
